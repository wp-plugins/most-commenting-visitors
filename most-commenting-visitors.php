...
Version: 1.0
visitor: Ruben Sargsyan
visitor URI: http://rubensargsyan.com/
*/
...
$most_commenting_visitors_plugin_version = "1.0";
...
function most_commenting_visitors_load(){
    ...
    if(get_option($most_commenting_visitors_plugin_prefix."widget_options")===false){
        $most_commenting_visitors_widget_options = array("title"=>$most_commenting_visitors_plugin_title,"count"=>5,"show_avatar"=>"no","show_count"=>"no");
